...
cd /scratch/cluster/sacks/esmf-testing/gfortran_9.3.0_mvapich2_O_develop
...
export ESMF_DIR=/scratch/cluster/sacks/esmf-testing/gfortran_9.3.0_mvapich2_O_develop
