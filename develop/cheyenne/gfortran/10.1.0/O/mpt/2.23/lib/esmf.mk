build time -- 2022-05-07 14:36:24.680539
...
ESMF_APPSDIR=/glade/scratch/rlong/esmf-testing/gfortran_10.1.0_mpt_O_develop/apps/appsO/Linux.gfortran.64.mpt.default
ESMF_LIBSDIR=/glade/scratch/rlong/esmf-testing/gfortran_10.1.0_mpt_O_develop/lib/libO/Linux.gfortran.64.mpt.default
...
ESMF_F90COMPILEPATHS=-I/glade/scratch/rlong/esmf-testing/gfortran_10.1.0_mpt_O_develop/mod/modO/Linux.gfortran.64.mpt.default -I/glade/scratch/rlong/esmf-testing/gfortran_10.1.0_mpt_O_develop/src/include -I/glade/u/apps/ch/opt/netcdf/4.7.4/gnu/10.1.0/include -I/glade/u/apps/ch/opt/netcdf/4.7.4/gnu/10.1.0/include
...
ESMF_F90LINKPATHS=-L/glade/scratch/rlong/esmf-testing/gfortran_10.1.0_mpt_O_develop/lib/libO/Linux.gfortran.64.mpt.default -L/glade/u/apps/ch/opt/netcdf/4.7.4/gnu/10.1.0/lib -L/glade/u/apps/ch/opt/netcdf/4.7.4/gnu/10.1.0/lib -L/glade/u/apps/ch/opt/gnu/10.1.0/lib/gcc/x86_64-pc-linux-gnu/10.1.0/../../../../lib64/
ESMF_F90ESMFLINKPATHS=-L/glade/scratch/rlong/esmf-testing/gfortran_10.1.0_mpt_O_develop/lib/libO/Linux.gfortran.64.mpt.default
ESMF_F90LINKRPATHS=-Wl,-rpath,/glade/scratch/rlong/esmf-testing/gfortran_10.1.0_mpt_O_develop/lib/libO/Linux.gfortran.64.mpt.default -Wl,-rpath,/glade/u/apps/ch/opt/netcdf/4.7.4/gnu/10.1.0/lib -Wl,-rpath,/glade/u/apps/ch/opt/netcdf/4.7.4/gnu/10.1.0/lib  -Wl,-rpath,/glade/u/apps/ch/opt/gnu/10.1.0/lib/gcc/x86_64-pc-linux-gnu/10.1.0/../../../../lib64/
ESMF_F90ESMFLINKRPATHS=-Wl,-rpath,/glade/scratch/rlong/esmf-testing/gfortran_10.1.0_mpt_O_develop/lib/libO/Linux.gfortran.64.mpt.default
...
ESMF_CXXCOMPILEPATHS= -I/glade/scratch/rlong/esmf-testing/gfortran_10.1.0_mpt_O_develop/src/include  -I/glade/u/apps/ch/opt/netcdf/4.7.4/gnu/10.1.0/include -I/glade/scratch/rlong/esmf-testing/gfortran_10.1.0_mpt_O_develop/src/prologue/yaml-cpp/include
ESMF_CXXCOMPILECPPFLAGS=-DESMF_NO_INTEGER_1_BYTE -DESMF_NO_INTEGER_2_BYTE -DESMF_VERSION_STRING_GIT='v8.3.0b14-2-gde129fc120' -DESMF_MOAB=1 -DESMF_LAPACK=1 -DESMF_LAPACK_INTERNAL=1 -DESMF_NO_ACC_SOFTWARE_STACK=1 -DESMF_NETCDF=1 -DESMF_YAMLCPP=1 -DESMF_YAML=1 -DESMF_PIO=1 -DESMF_NO_OPENACC -DESMF_TESTEXHAUSTIVE -DESMF_BOPT_O -DESMF_TESTCOMPTUNNEL -DESMF_TESTWITHTHREADS -DSx86_64_small=1 -DESMF_OS_Linux=1 -DESMF_COMM=mpt -DESMF_DIR=/glade/scratch/rlong/esmf-testing/gfortran_10.1.0_mpt_O_develop -D__SDIR__='' -DESMF_CXXSTD=11

ESMF_CXXLINKOPTS=  -m64 -mcmodel=small -pthread -Wl,--no-as-needed  -fopenmp
ESMF_CXXLINKPATHS=-L/glade/scratch/rlong/esmf-testing/gfortran_10.1.0_mpt_O_develop/lib/libO/Linux.gfortran.64.mpt.default -L/glade/u/apps/ch/opt/netcdf/4.7.4/gnu/10.1.0/lib -L/glade/u/apps/ch/opt/netcdf/4.7.4/gnu/10.1.0/lib -L/glade/u/apps/ch/opt/gnu/10.1.0/lib/gcc/x86_64-pc-linux-gnu/10.1.0/../../../../lib64/
ESMF_CXXESMFLINKPATHS=-L/glade/scratch/rlong/esmf-testing/gfortran_10.1.0_mpt_O_develop/lib/libO/Linux.gfortran.64.mpt.default
ESMF_CXXLINKRPATHS=-Wl,-rpath,/glade/scratch/rlong/esmf-testing/gfortran_10.1.0_mpt_O_develop/lib/libO/Linux.gfortran.64.mpt.default -Wl,-rpath,/glade/u/apps/ch/opt/netcdf/4.7.4/gnu/10.1.0/lib -Wl,-rpath,/glade/u/apps/ch/opt/netcdf/4.7.4/gnu/10.1.0/lib  -Wl,-rpath,/glade/u/apps/ch/opt/gnu/10.1.0/lib/gcc/x86_64-pc-linux-gnu/10.1.0/../../../../lib64/
ESMF_CXXESMFLINKRPATHS=-Wl,-rpath,/glade/scratch/rlong/esmf-testing/gfortran_10.1.0_mpt_O_develop/lib/libO/Linux.gfortran.64.mpt.default
...
ESMF_TRACE_LDPRELOAD=/glade/scratch/rlong/esmf-testing/gfortran_10.1.0_mpt_O_develop/lib/libO/Linux.gfortran.64.mpt.default/libesmftrace_preload.so
...
ESMF_INTERNAL_DIR=/glade/scratch/rlong/esmf-testing/gfortran_10.1.0_mpt_O_develop
ESMF_INTERNAL_MPIRUN=mpirun 

#
# !!! The following options were used on this ESMF build !!!
#
# ESMF_DIR: /glade/scratch/rlong/esmf-testing/gfortran_10.1.0_mpt_O_develop
# ESMF_OS: Linux
# ESMF_MACHINE: x86_64
# ESMF_ABI: 64
