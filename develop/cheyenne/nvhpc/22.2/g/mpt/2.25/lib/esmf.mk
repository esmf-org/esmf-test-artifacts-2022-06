build time -- 2022-05-26 18:56:48.771573
...
ESMF_APPSDIR=/glade/scratch/sacks/esmf-testing/nvhpc_22.2_mpt_g_develop/apps/appsg/Linux.nvhpc.64.mpt.default
ESMF_LIBSDIR=/glade/scratch/sacks/esmf-testing/nvhpc_22.2_mpt_g_develop/lib/libg/Linux.nvhpc.64.mpt.default
...
ESMF_F90COMPILEPATHS=-I/glade/scratch/sacks/esmf-testing/nvhpc_22.2_mpt_g_develop/mod/modg/Linux.nvhpc.64.mpt.default -I/glade/scratch/sacks/esmf-testing/nvhpc_22.2_mpt_g_develop/src/include -I/glade/u/apps/ch/opt/netcdf/4.8.1/nvhpc/22.2/include -I/glade/u/apps/ch/opt/netcdf/4.8.1/nvhpc/22.2/include
ESMF_F90COMPILECPPFLAGS=-DESMF_NO_INTEGER_1_BYTE -DESMF_NO_INTEGER_2_BYTE -DESMF_VERSION_STRING_GIT='v8.3.0b16' -DESMF_MOAB=1 -DESMF_LAPACK=1 -DESMF_LAPACK_INTERNAL=1 -DESMF_NO_ACC_SOFTWARE_STACK=1 -DESMF_NETCDF=1 -DESMF_YAMLCPP=1 -DESMF_YAML=1 -DESMF_PIO=1 -DESMF_NO_OPENACC -DESMF_TESTEXHAUSTIVE -DESMF_BOPT_g -DESMF_TESTCOMPTUNNEL -DESMF_TESTWITHTHREADS -DSx86_64_small=1 -DESMF_OS_Linux=1 -DESMF_COMM=mpt -DESMF_DIR=/glade/scratch/sacks/esmf-testing/nvhpc_22.2_mpt_g_develop -DESMF_NO_F2018ASSUMEDTYPE
...
ESMF_F90LINKPATHS=-L/glade/scratch/sacks/esmf-testing/nvhpc_22.2_mpt_g_develop/lib/libg/Linux.nvhpc.64.mpt.default -L/glade/u/apps/ch/opt/netcdf/4.8.1/nvhpc/22.2/lib -L/glade/u/apps/ch/opt/netcdf/4.8.1/nvhpc/22.2/lib
ESMF_F90ESMFLINKPATHS=-L/glade/scratch/sacks/esmf-testing/nvhpc_22.2_mpt_g_develop/lib/libg/Linux.nvhpc.64.mpt.default
ESMF_F90LINKRPATHS=-Wl,-rpath,/glade/scratch/sacks/esmf-testing/nvhpc_22.2_mpt_g_develop/lib/libg/Linux.nvhpc.64.mpt.default -Wl,-rpath,/glade/u/apps/ch/opt/netcdf/4.8.1/nvhpc/22.2/lib -Wl,-rpath,/glade/u/apps/ch/opt/netcdf/4.8.1/nvhpc/22.2/lib 
ESMF_F90ESMFLINKRPATHS=-Wl,-rpath,/glade/scratch/sacks/esmf-testing/nvhpc_22.2_mpt_g_develop/lib/libg/Linux.nvhpc.64.mpt.default
...
ESMF_CXXCOMPILEPATHS= -I/glade/scratch/sacks/esmf-testing/nvhpc_22.2_mpt_g_develop/src/include  -I/glade/u/apps/ch/opt/netcdf/4.8.1/nvhpc/22.2/include -I/glade/scratch/sacks/esmf-testing/nvhpc_22.2_mpt_g_develop/src/prologue/yaml-cpp/include
ESMF_CXXCOMPILECPPFLAGS=-DESMF_NO_INTEGER_1_BYTE -DESMF_NO_INTEGER_2_BYTE -DESMF_VERSION_STRING_GIT='v8.3.0b16' -DESMF_MOAB=1 -DESMF_LAPACK=1 -DESMF_LAPACK_INTERNAL=1 -DESMF_NO_ACC_SOFTWARE_STACK=1 -DESMF_NETCDF=1 -DESMF_YAMLCPP=1 -DESMF_YAML=1 -DESMF_PIO=1 -DESMF_NO_OPENACC -DESMF_TESTEXHAUSTIVE -DESMF_BOPT_g -DESMF_TESTCOMPTUNNEL -DESMF_TESTWITHTHREADS -DSx86_64_small=1 -DESMF_OS_Linux=1 -DESMF_COMM=mpt -DESMF_DIR=/glade/scratch/sacks/esmf-testing/nvhpc_22.2_mpt_g_develop -D__SDIR__='' -DESMF_CXXSTD=11 -DESMF_NO_F2018ASSUMEDTYPE

ESMF_CXXLINKOPTS=  -mcmodel=small -pthread -Wl,--no-as-needed  -mp
ESMF_CXXLINKPATHS=-L/glade/scratch/sacks/esmf-testing/nvhpc_22.2_mpt_g_develop/lib/libg/Linux.nvhpc.64.mpt.default -L/glade/u/apps/ch/opt/netcdf/4.8.1/nvhpc/22.2/lib -L/glade/u/apps/ch/opt/netcdf/4.8.1/nvhpc/22.2/lib
ESMF_CXXESMFLINKPATHS=-L/glade/scratch/sacks/esmf-testing/nvhpc_22.2_mpt_g_develop/lib/libg/Linux.nvhpc.64.mpt.default
ESMF_CXXLINKRPATHS=-Wl,-rpath,/glade/scratch/sacks/esmf-testing/nvhpc_22.2_mpt_g_develop/lib/libg/Linux.nvhpc.64.mpt.default -Wl,-rpath,/glade/u/apps/ch/opt/netcdf/4.8.1/nvhpc/22.2/lib -Wl,-rpath,/glade/u/apps/ch/opt/netcdf/4.8.1/nvhpc/22.2/lib 
ESMF_CXXESMFLINKRPATHS=-Wl,-rpath,/glade/scratch/sacks/esmf-testing/nvhpc_22.2_mpt_g_develop/lib/libg/Linux.nvhpc.64.mpt.default
...
ESMF_TRACE_LDPRELOAD=/glade/scratch/sacks/esmf-testing/nvhpc_22.2_mpt_g_develop/lib/libg/Linux.nvhpc.64.mpt.default/libesmftrace_preload.so
...
ESMF_INTERNAL_DIR=/glade/scratch/sacks/esmf-testing/nvhpc_22.2_mpt_g_develop
ESMF_INTERNAL_MPIRUN="mpirun "

#
# !!! The following options were used on this ESMF build !!!
#
# ESMF_DIR: /glade/scratch/sacks/esmf-testing/nvhpc_22.2_mpt_g_develop
# ESMF_OS: Linux
# ESMF_MACHINE: x86_64
# ESMF_ABI: 64
# ESMF_COMPILER: nvhpc
