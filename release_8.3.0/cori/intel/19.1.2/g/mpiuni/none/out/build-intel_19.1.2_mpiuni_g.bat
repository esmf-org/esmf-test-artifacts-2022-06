Fri May 27 02:07:33 PDT 2022
#!/bin/sh -l
#SBATCH --account=e3sm
#SBATCH -o build-intel_19.1.2_mpiuni_g.bat_%j.o
#SBATCH -e build-intel_19.1.2_mpiuni_g.bat_%j.e
#SBATCH --time=1:00:00
#SBATCH -C haswell
#SBATCH --qos=regular
#SBATCH --nodes=1
...
export ESMF_DIR=/global/cscratch1/sd/rsdunlap/esmf-testing/intel_19.1.2_mpiuni_g_release_8.3.0
