Thu May 26 23:58:09 PDT 2022
#!/bin/sh -l
#SBATCH --account=e3sm
#SBATCH -o test-intel_19.1.2_mpi_g.bat_%j.o
#SBATCH -e test-intel_19.1.2_mpi_g.bat_%j.e
#SBATCH --time=3:00:00
#SBATCH -C haswell
#SBATCH --qos=regular
#SBATCH --nodes=1
...
export ESMF_DIR=/global/cscratch1/sd/rsdunlap/esmf-testing/intel_19.1.2_mpi_g_release_8.3.0
